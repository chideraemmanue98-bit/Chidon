                  ...
                  {!paystackConfigured && (
                    <div className="p-3.5 bg-yellow-500/10 border border-yellow-500/20 rounded-xl space-y-1.5 text-xs text-yellow-600 dark:text-yellow-400 font-sans leading-relaxed">
                      ...
                      <p className="text-[11px]">
                        Please ensure <code className="bg-black/40 text-yellow-400 px-1 py-0.5 rounded font-mono text-[10px]">PAYSTACK_SECRET_KEY</code> is set in Netlify Environment Variables to unlock real payment processing.
                      </p>
                    </div>
                  )}
