...
`;
    ...
    try {
      ...
      if (!data.text) {
        throw new Error("No text response received from CHIDON AI engine proxy.");
      }
      ...
      <div id="template-header" className="p-6 border-b border-[var(--border-base)] bg-[var(--bg-card)]/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-[var(--text-secondary)]">Populate strategic copywriting blueprints instantly using automated CHIDON AI modeling.</p>
          </div>
        </div>
        ...
        <div id="template-network-metrics" className="flex items-center gap-3 bg-[var(--bg-app)] border border-[var(--border-base)] rounded-xl px-4 py-2 text-xs font-mono">
          ...
          <div className="text-left">
            ...
            <p className="text-[11px] font-bold text-cyan-primary">CHIDON IQ Core Active</p>
          </div>
        </div>
      </div>
            ...
            {isLoading && (
              <div id="template-loading-overlay" className="absolute inset-0 bg-slate-950/70 backdrop-blur-sm z-50 flex flex-col items-center justify-center p-6 text-center space-y-4">
                ...
                <div className="space-y-1 max-w-sm">
                  ...
                  <p className="text-xs text-slate-300 font-bold">CHIDON AI is structuring and compiling your variables into the layout...</p>
                  ...
                  >
                    ...
                    <div className="space-y-1 max-w-sm">
                      ...
                      <p className="text-[11px] text-[var(--text-secondary)] leading-relaxed">
                        Below is the static schema for your selected **{activeTemplate.label}** blueprint. Once you hit 'Populate', CHIDON AI will instantly morph your inputs into premium content.
                      </p>
                    </div>
